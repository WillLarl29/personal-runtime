...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/main.Actividad"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CrearActividadInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/actividades/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.ActualizarActividadInput"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                "description": "Borrado lógico: marca la actividad como inactiva (activa = FALSE)\nen vez de borrar la fila, para no perder su historial de checks_diarios\n(que referencia actividad_id) ni su aporte pasado al resumen.",
                "tags": [
                    "actividades"
                ],
        ...
        "/checks": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos del check",
                        "name": "check",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CrearCheckInput"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/main.CheckDiario"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/main.ResumenActividad"
                            }
                        }
                    },
                    "500": {
